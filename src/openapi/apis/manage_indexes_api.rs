...
pub async fn configure_index(configuration: &configuration::Configuration, index_name: &str, configure_index_request: models::ConfigureIndexRequest) -> Result<models::IndexModel, Error<ConfigureIndexError>> {
    ...
    let local_var_uri_str = format!("{}/indexes/{index_name}", local_var_configuration.base_path, index_name=crate::openapi::apis::urlencode(index_name));
...
pub async fn create_backup(configuration: &configuration::Configuration, index_name: &str, create_backup_request: models::CreateBackupRequest) -> Result<models::BackupModel, Error<CreateBackupError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/indexes/{index_name}/backups", local_var_configuration.base_path, index_name=crate::openapi::apis::urlencode(index_name));
...
pub async fn create_index_for_model(configuration: &configuration::Configuration, create_index_for_model_request: models::CreateIndexForModelRequest) -> Result<models::IndexModel, Error<CreateIndexForModelError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/indexes/create-for-model", local_var_configuration.base_path);
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateIndexForModelError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn create_index_from_backup(configuration: &configuration::Configuration, backup_id: &str, create_index_from_backup_request: models::CreateIndexFromBackupRequest) -> Result<(), Error<CreateIndexFromBackupError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/backups/{backup_id}/create-index", local_var_configuration.base_path, backup_id=crate::openapi::apis::urlencode(backup_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CreateIndexFromBackupError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
/// Delete a backup.
pub async fn delete_backup(configuration: &configuration::Configuration, backup_id: &str) -> Result<(), Error<DeleteBackupError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/backups/{backup_id}", local_var_configuration.base_path, backup_id=crate::openapi::apis::urlencode(backup_id));
...
pub async fn delete_collection(configuration: &configuration::Configuration, collection_name: &str) -> Result<(), Error<DeleteCollectionError>> {
    ...
    let local_var_uri_str = format!("{}/collections/{collection_name}", local_var_configuration.base_path, collection_name=crate::openapi::apis::urlencode(collection_name));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::DELETE, local_var_uri_str.as_str());
...
pub async fn describe_backup(configuration: &configuration::Configuration, backup_id: &str) -> Result<models::BackupModel, Error<DescribeBackupError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeBackupError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn describe_restore_job(configuration: &configuration::Configuration, job_id: &str) -> Result<models::RestoreJobModel, Error<DescribeRestoreJobError>> {
    let local_var_configuration = configuration;

    let local_var_client = &local_var_configuration.client;

    let local_var_uri_str = format!("{}/restore-jobs/{job_id}", local_var_configuration.base_path, job_id=crate::openapi::apis::urlencode(job_id));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DescribeRestoreJobError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_index_backups(configuration: &configuration::Configuration, index_name: &str, limit: Option<i32>, pagination_token: Option<&str>) -> Result<models::BackupList, Error<ListIndexBackupsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListIndexBackupsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_project_backups(configuration: &configuration::Configuration, ) -> Result<models::BackupList, Error<ListProjectBackupsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListProjectBackupsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
...
pub async fn list_restore_jobs(configuration: &configuration::Configuration, limit: Option<i32>, pagination_token: Option<&str>) -> Result<models::RestoreJobList, Error<ListRestoreJobsError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ListRestoreJobsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
